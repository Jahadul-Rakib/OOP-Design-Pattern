package com.oop.design_pattern.creational.abstract_factory_pattern.example_one.factory.bus_fectory.buses;

import com.oop.design_pattern.creational.abstract_factory_pattern.example_one.factory.Car;

public class FiftySitBus implements Car {
    ...
    public void drive() {
        ...
        System.out.println ("driving the Bus 50 passengers Bho....Bho.....");
    }
}
